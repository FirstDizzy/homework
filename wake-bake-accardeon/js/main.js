...
accordionLists.forEach(accordionList => {
    accordionList.addEventListener('click', (e) => {
        ...
        const openedItem = accordionList.querySelector('.accordion-list_item--opened');
        if (openedItem && openedItem !== accordionItem) {
            ...
            const openedContent = openedItem.querySelector('.accordion-list__control').nextElementSibling;
            if (openedContent) {
